export const Mobile = ({menuOpen, setMenuOpen}) => {
    return (
        <div className ={`fixed top-0 left-0 w-full bg-[rgba(21,25,30,0.8)] z-40 flex flex-col items-center justify-center
            ...
            <a href="#home" onClick={() => setMenuOpen(false)}
                className={`text-2xl hover:text-[#766DA7] font-semibold text-white my-4 transform transition-transform duration-300
