            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    hover:-translate-y-1 hover:border-cyan-400/30 hover:shadow-[0_2px_8px_rgba(255,255,255,0.1)] transition">
                        ...
                        <p className="text-gray-200 mb-4">
                           A collaborative, interdisciplinary, Cornell Engineering Project Team developing a semi-autonomous rover
                           to compete in the annual University Rover Challenge. As software subteam member, I'm developing 
                           an algorithm for autonomous navigation to GPS coordinates and custom UI elements
                           for a control dashboard for the competition crew.
                        </p>
                        <div className="flex flex-wrap gap-2">
